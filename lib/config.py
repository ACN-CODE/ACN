...
__C.MODEL.BILINEAR.HEAD_DIM = 128
...
__C.MODEL.BILINEAR.ENCODE_ATTTYPE = 'Capsule'

__C.MODEL.BILINEAR.DECODE_ATTTYPE = 'Capsule'

__C.MODEL.BILINEAR.ATTTYPE = 'Capsule'
...
__C.PARAM.MAX_ATT_NUM = 'MAX_ATT_NUM'
