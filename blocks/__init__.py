...
from blocks.capsule_lowrank_bilinear_block import CapsuleLowRankBilinearEncBlock, CapsuleLowRankBilinearDecBlock

__factory = {
    'FeedForward': FeedForwardBlock,
    'LowRankBilinearEnc': LowRankBilinearEncBlock,
    'LowRankBilinearDec': LowRankBilinearDecBlock,
    'CapsuleLowRankBilinearEnc': CapsuleLowRankBilinearEncBlock,
    'CapsuleLowRankBilinearDec': CapsuleLowRankBilinearDecBlock
}
